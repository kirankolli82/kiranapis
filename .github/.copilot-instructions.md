...
- Root package: com.kiran.musicapi
...
- Outputs: return the same domain types used in the project (packages under com.kiran.musicapi).
...
- Primary package owner: com.kiran.musicapi
