...
public class KafkaContainer extends org.testcontainers.kafka.KafkaContainer {
    ...
    private void setWaitStrategy() {
        var waitStrategy = super.getWaitStrategy()
    ...
    private void setupEnv() {
        ...
        env.put("KAFKA_LISTENER_SECURITY_PROTOCOL_MAP", "CONTROLLER:PLAINTEXT,PLAINTEXT:PLAINTEXT,PLAINTEXT_HOST:PLAINTEXT");
        env.put("KAFKA_LISTENERS", "PLAINTEXT://0.0.0.0:29092,PLAINTEXT_HOST://0.0.0.0:9092,CONTROLLER://0.0.0.0:29093");
